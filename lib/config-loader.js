var fs = require('fs')
  ...
  , InternalResources = require(__dirname + '/resources/internal-resources')
  , Files = require(__dirname + '/resources/files')
  , ClientLib = require(__dirname + '/resources/client-lib')
  , Dashboard = require(__dirname + '/resources/dashboard')
...
function loadTypes(basepath, fn) {
  _loadTypes(basepath, function(defaults, types) {
...
function addInternalResources(server, basepath, resources, fn) {
  var publicFolderQ = Q.fcall(function() {
    var defaultFolder =  server.options.publicDir || './public';
